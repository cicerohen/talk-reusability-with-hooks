...
function App() {
  ...
  const fechCharacters = React.useCallback(async () => {
    try {
      setIsFetching(true);
      const response = await fetchApi("/public/characters");
  ...
  }, [setIsFetching, setCharacters, setError]);
  ...
  return (
    <div className="App" style={styles.app}>
      ...
      <header style={styles.header}>
        ...
        <div>
          <button style={styles.button} onClick={fechCharacters}>
            Recarregar lista
          </button>
          {selectedCharacter ? (
            <button
